(ns lucid.dive.query.compile
  (:require [lucid.dive.query.common :as common]
            [lucid.dive.query.match :as match]
            [lucid.dive.query.traverse :as traverse]
            [lucid.dive.query.walk :as query]
...
(defn compile-section-base
  ...
  => {:is lucid.dive.query.common/any}"
  {:added "0.2"}
  [section]
