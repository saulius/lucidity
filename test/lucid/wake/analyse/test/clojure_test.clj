(ns lucid.wake.analyse.test.clojure-test
  (:use hara.test)
  (:require [lucid.wake.analyse.test.clojure :refer :all]
            [lucid.wake.analyse.test.common :as common]
            [rewrite-clj.zip :as z]))

^{:refer lucid.wake.analyse.test.clojure/gather-is-form :added "1.1"}
...
^{:refer lucid.wake.analyse.test.clojure/gather-deftest :added "1.1"}
