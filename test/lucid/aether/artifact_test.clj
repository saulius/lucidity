(ns lucid.aether.artifact-test
  (:use hara.test)
  (:require [lucid.aether.artifact :refer :all])
  (:import [org.eclipse.aether.artifact Artifact  DefaultArtifact]))

^{:refer lucid.aether.artifact/artifact->vector :added "1.1"}
...
^{:refer lucid.aether.artifact/artifact->string :added "1.1"}
...
^{:refer lucid.aether.artifact/artifact :added "1.1"}
