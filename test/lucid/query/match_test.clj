(ns lucid.query.match-test
  (:use hara.test)
  (:require [lucid.query.match :refer :all]
            [rewrite-clj.zip :as z]))

^{:refer lucid.query.match/p-fn :added "0.1"}
...
^{:refer lucid.query.match/p-is :added "0.1"}
...
^{:refer lucid.query.match/p-equal :added "0.1"}
...
^{:refer lucid.query.match/p-meta :added "0.1"}
...
^{:refer lucid.query.match/p-type :added "0.1"}
...
^{:refer lucid.query.match/p-form :added "0.1"}
...
^{:refer lucid.query.match/p-pattern :added "0.1"}
...
^{:refer lucid.query.match/p-or :added "0.1"}
...
^{:refer lucid.query.match/p-parent :added "0.1"}
...
^{:refer lucid.query.match/p-child :added "0.1"}
...
^{:refer lucid.query.match/p-first :added "0.1"}
...
^{:refer lucid.query.match/p-last :added "0.1"}
...
^{:refer lucid.query.match/p-nth :added "0.1"}
(fact "checks that the last element of the container has a certain characteristic"
...
^{:refer lucid.query.match/p-nth-left :added "0.1"}
(fact "checks that the last element of the container has a certain characteristic"
...
^{:refer lucid.query.match/p-nth-right :added "0.1"}
(fact "checks that the last element of the container has a certain characteristic"
...
^{:refer lucid.query.match/p-contains :added "0.1"}
...
^{:refer lucid.query.match/p-ancestor :added "0.1"}
...
^{:refer lucid.query.match/p-sibling :added "0.1"}
...
^{:refer lucid.query.match/p-left :added "0.1"}
...
^{:refer lucid.query.match/p-right :added "0.1"}
...
^{:refer lucid.query.match/p-left-of :added "0.1"}
...
^{:refer lucid.query.match/p-right-of :added "0.1"}
...
^{:refer lucid.query.match/p-left-most :added "0.1"}
(fact "checks that any element on the right has a certain characteristic"
...
^{:refer lucid.query.match/p-right-most :added "0.1"}
(fact "checks that any element on the right has a certain characteristic"
