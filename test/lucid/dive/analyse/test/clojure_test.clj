(ns lucid.dive.analyse.test.clojure-test
  (:use hara.test)
  (:require [lucid.dive.analyse.test.clojure :refer :all]
            [lucid.dive.analyse.test.common :as common]
            [rewrite-clj.zip :as z]))

^{:refer lucid.dive.analyse.test.clojure/gather-is-form :added "1.1"}
...
^{:refer lucid.dive.analyse.test.clojure/gather-deftest :added "1.1"}
